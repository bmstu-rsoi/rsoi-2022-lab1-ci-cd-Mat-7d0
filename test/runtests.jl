...
# !!! Main.UserApp is configured as an alias for Main.Lab01 and you might encounter it in some tests
using Main.Lab01, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Lab01 tests" begin
  @includetests ARGS
end
